...
1. Stride Length: Estimated as height * 0.414.
2. Time: Calculated by dividing total distance (steps * stride) by velocity (m/s).
3. Calories: (Time_in_minutes * MET * 3.5 * weight) / 200.
   Example: Enter your height in meters: 1.8 Enter your weight in kgs: 80 Enter walking pace (slow 2mph , medium 3mph, fast 4mph): medium Enter number of steps: 5000 You have burned: 227.08 calories
